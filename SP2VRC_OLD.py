        ...
        try:
            ...
            try:
                ...
                if log_in != True and log_in != False:
                    ...
                    settings["log_in"] = defaults["log_in"]
                    noErrors += 1
            except:
                noErrors += 1
...
class set_keybinds():
    ...
    def update_keybinds(keybinds):
        ...
        keyboard.add_hotkey(keybinds["Force Update"],manual_update)
...
async def vrcLogIn():
    ...
    with ApiClient(vrcconfig) as api_client:
        api_client.user_agent = "SimplyPluralVRC/1.3.3 kristen.e.lane2004@gmail.com"
